...
export default function RegisterPage() {
  ...
  // State for role selection, defaults to "user"
  const [role, setRole] = useState("user"); // Optional: manage role state
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl rounded-xl p-8 md:p-12">
          ...
          <form className="space-y-6" onSubmit={handleRegister}>
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-lg bg-purple-600 px-3 py-3 text-sm font-semibold leading-6 text-white shadow-md hover:bg-gradient-to-r hover:from-purple-700 hover:to-purple-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-600 transition duration-150 ease-in-out"
              >
                Register
              </button>
            </div>
